                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">Advised Students</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $instructorNumber = $_SESSION['issn'];
                                        $sql = "SELECT  S.ssn, S.studentid, S.studentname, S.gradorUgrad FROM student S WHERE advisorSsn = '$instructorNumber'";
