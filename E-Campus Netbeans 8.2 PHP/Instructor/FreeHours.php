                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">Free Hours</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $instructorNumber = $_SESSION['issn'];
                                        $sql = "SELECT T.dayy, T.hourr FROM timeslot T WHERE (T.dayy, T.hourr) NOT IN (SELECT W.dayy, W.hourr FROM enrollment E NATURAL JOIN weeklyschedule W 
                                WHERE E.yearr=2022 AND
                                E.semester = 'spring' AND
                                E.sssn IN (SELECT E2.sssn FROM enrollment E2
                                WHERE E2.sssn = E.sssn AND E2.issn= '$instructorNumber' AND E2.courseCode='comp2222' and E2.sectionId = 1  AND E2.yearr=2022 and  E2.semester = 'spring'))";
