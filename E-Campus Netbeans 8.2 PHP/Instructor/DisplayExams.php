                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">Display Exams</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $instructorNumber = $_SESSION['issn'];
                                        $sql = "SELECT C.courseCode, C.courseName, E.eName, E.edate, E.yearr FROM exam E, course C WHERE E.courseCode = C.courseCode AND E.issn = '$instructorNumber' ORDER BY yearr DESC";
