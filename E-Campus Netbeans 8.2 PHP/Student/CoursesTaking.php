                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">Courses</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $studentNumber = $_SESSION['sssn'];
                                        $sql = " SELECT C.courseCode, C.courseName, E.sectionId, E.yearr, E.semester, E.lettergrade FROM enrollment E, course C WHERE sssn = '$studentNumber' "
                                                . "AND C.courseCode = E.courseCode AND E.yearr = 2022 ORDER BY E.yearr DESC";
