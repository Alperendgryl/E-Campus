                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">Superviser List</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $studentNumber = $_SESSION['sssn'];
                                        $sql = " SELECT rankk, iname, dname FROM gradstudent, instructor WHERE instructor.ssn = gradstudent.supervisorSsn AND gradstudent.ssn = '$studentNumber'"; // SSN of supervisor must be private to students
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            . "<tr>"
                                            . "<th>Supervisor Department Name</th>"
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo "You are not graduate student. In order to see your superviser, you must be graduate first."; ?>
                                                </td>
                                            </tr>      
                                            <?php
                                        }
