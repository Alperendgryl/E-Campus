                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">List Of Courses Supposed To be Taken</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $studentNumber = $_SESSION['sssn'];
                                        $sql = " SELECT C.courseCode, C.courseName, C.ects, C.numHours, C.prereq_courseCode
                                FROM curriculacourses CC, course C
                                WHERE CC.courseCode = C.courseCode AND dName LIKE 'comp%' AND C.courseCode NOT IN (SELECT courseCode
                                FROM enrollment
                                WHERE sssn = '$studentNumber') ORDER BY ects DESC";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['numHours']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['prereq_courseCode']; ?>
                                                    </td>
                                                </tr>      
                                                <?php
                                            }
