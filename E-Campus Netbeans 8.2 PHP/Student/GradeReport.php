                            ...
                            <div class="col bg-white">
                                <div class="card">
                                    <div class="card-header bg-blue text-white">
                                        <h4 class="text-light" style="height: 8px; font-family: Arial; font-size:18px">Grade Report (Transcript)</h4>
                                    </div>
                                    <li class="list-group-item border px-3 pb-3 pt-1">
                                        <?php
                                        $studentNumber = $_SESSION['sssn'];
                                        $sql = " SELECT C.courseCode, C.courseName, C.ects, E.lettergrade, E.yearr FROM Course C, enrollment E WHERE C.courseCode = E.courseCode AND sssn = '$studentNumber'"
                                                . "ORDER BY yearr DESC";
